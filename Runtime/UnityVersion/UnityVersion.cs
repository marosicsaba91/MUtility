...
public struct UnityVersion : IComparable<UnityVersion>, IComparable<string>
{
    ...
    public int CompareTo(UnityVersion other)
    {
        ...
        if (minor1 != other.minor1) return minor1 > other.minor1 ? 1 : -1;
        if (minor2 != other.minor2) return minor2 > other.minor2 ? 1 : -1;
        if (releaseType != other.releaseType) return releaseType > other.releaseType ? 1 : -1;
