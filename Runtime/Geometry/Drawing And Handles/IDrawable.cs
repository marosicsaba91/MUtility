...
namespace Utility
{
    ...
    public static class DrawableExtensions
    {
        ...
        public static void DrawGizmo(this IDrawable self, Vector3 offet, Color color) => self.ToDrawable().DrawGizmo(offet, color);
        public static void DrawDebug(this IDrawable self, Vector3 offet, Color color) => self.ToDrawable().DrawDebug(offet, color);
