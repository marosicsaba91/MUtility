...
{
	[Serializable]
	public struct Capsule2D : IPolygon, IWireShape, IEasyHandleable, IArea
	{
		...
		public WireShape ToDrawable(int circleSegmentCount) => new(ToPolygon(circleSegmentCount).ToArray());
