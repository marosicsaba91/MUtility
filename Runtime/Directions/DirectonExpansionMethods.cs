...
namespace MUtility
{
    public static class DirectionExpanded
    {
        public static GeneralDirection3D GetPerpendicularRightHand(this GeneralDirection3D dir)
        {
            switch (dir)
            {
                case GeneralDirection3D.Right: return GeneralDirection3D.Down;
                case GeneralDirection3D.Up: return GeneralDirection3D.Back;
                case GeneralDirection3D.Forward: return GeneralDirection3D.Left;

                case GeneralDirection3D.Left: return GeneralDirection3D.Forward;
                case GeneralDirection3D.Down: return GeneralDirection3D.Right;
                case GeneralDirection3D.Back: return GeneralDirection3D.Up;
                default:
        ...
        public static GeneralDirection3D GetPerpendicularLeftHand(this GeneralDirection3D dir)
        {
            switch (dir)
            {
                case GeneralDirection3D.Right: return GeneralDirection3D.Back;
                case GeneralDirection3D.Up: return GeneralDirection3D.Left;
                case GeneralDirection3D.Forward: return GeneralDirection3D.Down;

                case GeneralDirection3D.Left: return GeneralDirection3D.Up;
                case GeneralDirection3D.Down: return GeneralDirection3D.Forward;
                case GeneralDirection3D.Back: return GeneralDirection3D.Right;
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static Vector2 ToVector(this GeneralDirection2D dir)
        {
            switch (dir)
            {
                case GeneralDirection2D.Up: return new Vector2(0, 1);
                case GeneralDirection2D.Down: return new Vector2(0, -1);
                case GeneralDirection2D.Right: return new Vector2(1, 0);
                case GeneralDirection2D.Left: return new Vector2(-1, 0);
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static Vector2 ToVector(this Direction2D dir)
        {
            switch (dir)
            {
                case Direction2D.Up: return new Vector2(0, 1);
                case Direction2D.Down: return new Vector2(0, -1);
                case Direction2D.Right: return new Vector2(1, 0);
                case Direction2D.Left: return new Vector2(-1, 0);
                case Direction2D.UpRight: return new Vector2(1, 1);
                case Direction2D.DownRight: return new Vector2(1, -1);
                case Direction2D.DownLeft: return new Vector2(-1, -1);
                case Direction2D.UpLeft: return new Vector2(-1, 1);
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static Vector2Int ToVectorInt(this GeneralDirection2D dir)
        {
            switch (dir)
            {
                case GeneralDirection2D.Up: return new Vector2Int(0, 1);
                case GeneralDirection2D.Down: return new Vector2Int(0, -1);
                case GeneralDirection2D.Right: return new Vector2Int(1, 0);
                case GeneralDirection2D.Left: return new Vector2Int(-1, 0);
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static Vector3Int ToVectorInt(this GeneralDirection3D dir)
        {
            switch (dir)
            {
                case GeneralDirection3D.Up: return new Vector3Int(0, 1, 0);
                case GeneralDirection3D.Down: return new Vector3Int(0, -1, 0);
                case GeneralDirection3D.Right: return new Vector3Int(1, 0, 0);
                case GeneralDirection3D.Left: return new Vector3Int(-1, 0, 0);
                case GeneralDirection3D.Forward: return new Vector3Int(0, 0, 1);
                case GeneralDirection3D.Back: return new Vector3Int(0, 0, -1);
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static Vector2Int ToVectorInt(this Direction2D dir)
        {
            switch (dir)
            {
                ...
                case Direction2D.UpRight: return new Vector2Int(1, 1);
                case Direction2D.DownRight: return new Vector2Int(1, -1);
                case Direction2D.DownLeft: return new Vector2Int(-1, -1);
                case Direction2D.UpLeft: return new Vector2Int(-1, 1);
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static int GetAngle(this GeneralDirection2D dir)
        {
            switch (dir)
            {
                case GeneralDirection2D.Up: return 90;
                case GeneralDirection2D.Down: return 270;
                case GeneralDirection2D.Right: return 0;
                case GeneralDirection2D.Left: return 180;
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static int GetAngle(this Direction2D dir)
        {
            switch (dir)
            {
                case Direction2D.Up: return 90;
                case Direction2D.Down: return 270;
                case Direction2D.Right: return 0;
                case Direction2D.Left: return 180;
                case Direction2D.UpRight: return 45;
                case Direction2D.DownRight: return 315;
                case Direction2D.DownLeft: return 225;
                case Direction2D.UpLeft: return 135;
                default:
                    throw new ArgumentOutOfRangeException(nameof(dir), dir, null);
            }
        }
        ...
        public static GeneralDirection3D LeftHandedRotate(this GeneralDirection3D self, Axis3D axis, int step)
        {
            ...
            if (step == 2) return self.Opposite();
            if (step == 3)
                self = self.Opposite();
            ...
            switch (axis)
            {
                case Axis3D.X:
                    switch (self)
                    {
                        case GeneralDirection3D.Up: return GeneralDirection3D.Forward;
                        case GeneralDirection3D.Forward: return GeneralDirection3D.Down;
                        case GeneralDirection3D.Down: return GeneralDirection3D.Back;
                        case GeneralDirection3D.Back: return GeneralDirection3D.Up;
                    }
                ...
                case Axis3D.Y:
                    ...
                    {
                        case GeneralDirection3D.Right: return GeneralDirection3D.Back;
                        case GeneralDirection3D.Back: return GeneralDirection3D.Left;
                        case GeneralDirection3D.Left: return GeneralDirection3D.Forward;
                        case GeneralDirection3D.Forward: return GeneralDirection3D.Right;
                    }
                ...
                case Axis3D.Z:
                    switch (self)
                    {
                        case GeneralDirection3D.Right: return GeneralDirection3D.Up;
                        case GeneralDirection3D.Up: return GeneralDirection3D.Left;
                        case GeneralDirection3D.Left: return GeneralDirection3D.Down;
                        case GeneralDirection3D.Down: return GeneralDirection3D.Right;
                    }
