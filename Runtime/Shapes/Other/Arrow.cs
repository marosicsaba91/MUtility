...
{
	[Serializable]
	public struct Arrow : IWireShape, IEasyHandleable
	{
		...
		Ray ToRay => new(origin, DirectionVector);

		public WireShape ToWireShape() => ToDrawable(DrawingSettings.Default);
		public WireShape ToDrawable(DrawingSettings visuals)
		{
			Vector3 normal;
		...
		public struct DrawingSettings
		{
			...
			public static DrawingSettings Default => new(defaultBaseLineLength, defaultHeadLength, defaultHeadAngle);
